	...
	render () {
		return (
			<div className="section">
				...
				<Select.Async multi={this.state.multi} onSelectResetsInput={false} value={this.state.value} onChange={this.onChange} onValueClick={this.gotoContributor} valueKey="github" labelKey="name" loadOptions={this.getContributors} />
