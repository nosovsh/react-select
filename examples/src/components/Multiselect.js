	...
	render () {
		return (
			<div className="section">
				...
				<Select multi simpleValue onSelectResetsInput={false} hasSelectAll disabled={this.state.disabled} value={this.state.value} placeholder="Select your favourite(s)" options={this.state.options} onChange={this.handleSelectChange} />
